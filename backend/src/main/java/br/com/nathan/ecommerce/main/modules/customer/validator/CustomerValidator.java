...
public class CustomerValidator implements Validator<Customer> {
    ...
    private Map<String, List<String>> executeValidations(Customer object) {
        ...
        return this.createErrorMap(cpfErrors, emailErrors, passwordErrors, nameErrors, phoneErrors, addressErrors, cardErrors);
    }
    ...
    @SafeVarargs
    private Map<String, List<String>> createErrorMap(Map<String, List<String>> ...maps) {
        var errorMap = new HashMap<String, List<String>>();
